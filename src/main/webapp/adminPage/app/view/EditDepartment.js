/*
 * File: app/view/EditDepartment.js
 *
...
Ext.define('Xixixi.view.EditDepartment', {
    extend: 'Ext.window.Window',
    alias: 'widget.editdepartment',

    requires: [
        'Xixixi.view.EditDepartmentViewModel',
        'Ext.form.Panel',
        'Ext.form.field.Text',
        'Ext.button.Button'
    ],
    ...
    items: [
        {
            ...
            items: [
                ...
                },
                {
                    ...
                    validateBlank: true,
                    listeners: {
                        blur: 'onEditDepartmentNameBlur'
                    }
                },
                {
                    xtype: 'textfield',
                    id: 'editDepartmentDesc',
                    maxWidth: 260,
                    width: 260,
                    fieldLabel: '部门描述',
                    labelAlign: 'right',
    ...
    onEditDepartmentNameBlur: function(component, event, eOpts) {
        var departmentName = component.getValue();
        this.validateDepName(departmentName);
    },

    onEditDepSubmitClick: function(button, e, eOpts) {
    ...
    onEditDepCancelClick: function(button, e, eOpts) {
